...
class PromptModal(discord.ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            if any(channel.id == self.bot.config['log_channel_id'] for channel in self.interaction.guild.channels):
                ...
                print(f"Log channel not found: {self.bot.config['log_channel_id']}")
